...
ActiveRecord::Schema.define(version: 2021_03_31_022703) do
  ...
  create_table "archives", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "item_id"
    t.index ["item_id"], name: "index_archives_on_item_id"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "last_name_ruby", default: "", null: false
  ...
  add_foreign_key "archives", "items"
